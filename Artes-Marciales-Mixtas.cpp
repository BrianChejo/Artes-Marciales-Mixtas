...
void incripcionAtleta(sNodoA*& lstA, sLuchador nuevo, int &id_luchador){
	...
	cout<< "El ID asignado al atleta cargado es [" << nuevo.id_luchador << "]" << endl;
}
void generarMainCard(sNodoA* lstA, int id_luchador){
	if(id_luchador < 10){
...
void actualizarRecord(sNodoA* lstA){
	...
	cout<< "Luchador encontrado: " << aux->luchador.nombre << " (" << aux->luchador.apodo << ")" << endl;
	cout<< "Record actual: " << aux->luchador.victorias << "victorias - " << aux->luchador.derrotas << "derrotas" << endl;
	cout<< "" << endl;
	cout<< "Ingrese victorias a sumar (o restar si es negativo): ";
	cin>> v;
	cout<< "Ingrese derrotas a sumar (o restar si es negativo): ";
	cin>> d;

	aux->luchador.victorias += v;
	aux->luchador.derrotas += d;
	
	cout<< "" << endl;
	cout<< "Record actualizado con exito!" << endl;
	cout<< "Nuevo record: " << aux->luchador.victorias << "victorias - " << aux->luchador.derrotas << "derrotas" << endl;
}
void guardarGym(FILE* arcLuchadores, sNodoA* lstA){
